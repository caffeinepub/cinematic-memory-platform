...
import type { Memory as _Memory, UserProfile as _UserProfile, UserRole as _UserRole } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async createMemory(arg0: Memory): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.createMemory(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getMemoryById(arg0: bigint): Promise<Memory | null> {
        if (this.processError) {
            try {
                const result = await this.actor.getMemoryById(arg0);
    ...
    async getViewedMemoriesCount(): Promise<bigint> {
        if (this.processError) {
            try {
                const result = await this.actor.getViewedMemoriesCount();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getViewedMemoryIds(): Promise<Array<bigint>> {
        if (this.processError) {
            try {
                const result = await this.actor.getViewedMemoryIds();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async markMemoryViewed(arg0: bigint): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.markMemoryViewed(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async updateMemory(arg0: bigint, arg1: Memory): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.updateMemory(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
function from_candid_opt_n6(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: [] | [_Memory]): Memory | null {
    return value.length === 0 ? null : value[0];
}
